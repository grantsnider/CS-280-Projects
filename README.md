...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://grantsnider.github.io/CS-280-Projects/)
[![GitHub Actions CI](https://github.com/grantsnider/CS-280-Projects/actions/workflows/CI.yml/badge.svg)](https://github.com/grantsnider/CS-280-Projects/actions/workflows/CI.yml?query=branch%3Amain)
...
- `lib`: contains external dependencies, in the form of .jar files. For this class, you will be making use of the code at [this repository](https://github.com/grantsnider/AbstractDataTypes).
